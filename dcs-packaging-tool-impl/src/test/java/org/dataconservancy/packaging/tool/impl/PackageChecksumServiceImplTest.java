...
public class PackageChecksumServiceImplTest {
    ...
    public void setup() throws Exception {
        ...
        String fileOneMd5Sum = "07318f5ba9b5a9a437a4596364518f2b";
        String fileOneSha1Sum = "5a6b55bb58e46952aece87f8cca46ba9b53c5628";
        ...
        String fileTwoMd5Sum = "81a2f2595ff8f53f0c9c731f0d0dc6f0";
        String fileTwoSha1Sum = "ddfd1963496d51662436ddc7da8016e7e3070d8f";
    ...
    public void testSingleFileMD5Result(){
      List<Checksum> fileOneMD5List = new ArrayList<>();
      fileOneMD5List.add(checksumFileOneMd5);
      Map<File, List<Checksum>> expected = new HashMap<>();
    ...
    public void testSingleFileTwoAlgorithmsResult(){
      List<Checksum> fileOneList = new ArrayList<>();
    ...
    public void testTwoFilesTwoAlgorithmsResult(){
      ...
      List<Checksum> fileTwoList = new ArrayList<>();
