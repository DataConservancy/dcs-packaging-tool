...
public class PairTest {
    ...
    public void testEquals() {
        Pair<String, String> stringPair = new Pair<>("foo", "bar");
        Pair<String, String> differentStringPair = new Pair<>("bar", "baz");
        Pair<String, String> samePair = new Pair<>("foo", "bar");
        assertFalse(stringPair.equals(differentStringPair));
        assertEquals(stringPair, stringPair);
        assertEquals(stringPair, samePair);
        
        
        Pair<String, Integer> mixedPair = new Pair<>("foo", 1);
        Pair<String, Integer> differentMixedPair = new Pair<>("foo", 2);
        Pair<String, Integer> sameMixedPair = new Pair<>("foo", 1);
